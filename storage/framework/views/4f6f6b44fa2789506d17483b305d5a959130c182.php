          ...
          <form class="form-horizontal" action="<?php echo e(URL::to('users/finance/deposit')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-3 col-xs-12 control-label"><?php echo e(__('main.picture')); ?><span class="asterisk">*</span></label>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/azorder/resources/views/users/deposit.blade.php ENDPATH**/ ?>
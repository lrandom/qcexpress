      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if(strpos(url()->current(),'admin/transport/')!=false){echo 'active';} ?>">
            ...
            <ul class="treeview-menu">
              <li <?php if(strpos(url()->current(),'admin/transport/request_transport')!=false){echo 'class="active"';} ?>>
                <a href="<?php echo e(URL::to('admin/transport/request_transport')); ?>"><?php echo e(__('main.request_transport')); ?></a>
              </li>
  
              <li <?php if(strpos(url()->current(),'admin/transport/bill_transport')!=false){echo 'class="active"';} ?>>
                <a href="<?php echo e(URL::to('admin/transport/bill_transport')); ?>"><?php echo e(__('main.bill_transport')); ?></a>
              </li>
            </ul>
        </li>
        ...
        <li class="treeview <?php if(strpos(url()->current(),'admin/users')!=false){echo 'active';} ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li <?php if(strpos(url()->current(),'admin/users/role')!=false){echo 'class="active"';} ?>>
                <a href="<?php echo e(asset('admin/users/role')); ?>"><?php echo e(__('main.role')); ?></a>
              </li>
              <li <?php if(strpos(url()->current(),'admin/users/perm')!=false){echo 'class="active"';} ?>>
                  <a href="<?php echo e(asset('admin/users/perm')); ?>"><?php echo e(__('main.perm')); ?></a>
                </li>
          </ul>
        </li>
...
</body><?php /**PATH /Library/WebServer/Documents/azorder/resources/views/layouts/admin.blade.php ENDPATH**/ ?>
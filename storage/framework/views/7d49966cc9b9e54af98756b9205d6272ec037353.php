...
<?php echo $__env->make('shared.filter_order_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <td style="width: 40%; vertical-align: center;">
                    <div style="display: flex; align-content: center;">
                      <?php if($r1->picture!=null): ?>
                        <img style="float:left;width:85px;margin-right:10px" src="<?php echo e($r1->picture); ?>">
                      <?php endif; ?>
                    ...
                    <table class="table order_value">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($r->transport_cn_vn!=null): ?>
                                      <?php echo e(formatVND($r->transport_cn_vn)); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <b><?php echo e(formatCNY(($total_price + (($total_price/100)*($r->fee_service)) + ($r->transport_cn) + ($r->wood_package)) + (($r->transport_cn_vn)/($r->exchange_rate)))); ?></b>
                                    - <b><?php echo e(formatVND(($total_price + (($total_price/100)*($r->fee_service)) + ($r->transport_cn) + ($r->wood_package))*($r->exchange_rate) + ($r->transport_cn_vn))); ?></b>
                                </td>
                            </tr>
                              ...
                              <td>
                                ...
                                <?php if($r->is_final != 1 && $r->status != 20 && $r->status==7): ?>
                                  <form action="payment" method="POST">
                                    ...
                                    <?php else: ?>
                                      <button type="submit" class='btn btn-success'><?php echo e(__('main.pay')); ?></button>
                                    <?php endif; ?>
                                  </form>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/qcexpress/resources/views/users/order.blade.php ENDPATH**/ ?>
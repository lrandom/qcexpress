                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $index++; ?>
                                    <tr class="item-wrapper">
                                        ...
                                        <td>
                                            ...
                                            <input class="input-cny-price" type="hidden" value="<?php echo e($r['price']); ?>"/>
                                        ...
                                        <td>
                                            ...
                                            <div class="stuff-vnd-price">
                                                <input class="price-only-item" type="hidden" value="<?php echo e($r['price']*$r['rate']*$r['quantity']); ?>">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <form action="<?php echo e(URL::to('users/cart/make_order')); ?>" method="POST">
                            ...
                            <div class="group-ip">
                                ...
                                <input class="od-rate" data-only="tmalworld<?php echo e($key); ?>" type="hidden" value="<?php echo e($r['rate']); ?>" name="owner_type[1][-1][<?php echo e($key); ?>][rate]"/>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/qcexpress/resources/views/users/cart.blade.php ENDPATH**/ ?>